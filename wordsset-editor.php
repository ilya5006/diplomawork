...
require_once __DIR__ . '/model/functions/getWordssetInfo.php';
...
$wordssetInfo = getWordssetInfo($mysqli, (int) $_GET['id']);

$words = explode(' ', $wordssetInfo['words']);
...
<head>
    ...
    <link rel="stylesheet" href="./assets/css/wordsset-editor.css">

    <script src="./assets/js/libs/selectable.min.js"></script>
...
<body>
    <?php 
    include './views/wordsset-editor.php';
    ?>

    <script src="./assets/js/wordsset-editor.js"></script>
</body>
</html>