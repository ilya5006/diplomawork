...
require_once __DIR__ . '/model/functions/getUserInfo.php';
...
$userInfo = getUserInfo($mysqli, (int) $_GET['id']);
...
<head>
    ...
    <link rel="stylesheet" href="./assets/css/student-account.css">

    <title>Аккаунт</title>
</head>
<body>
    <?php 
    include './views/student-account.php';
    ?>
</body>
</html>